...
const UserList = () => {
  ...
  return (
    <div id="tabela" className="flex items-center pt-20 flex-col min-h-screen">
      ...
      <div className="flex flex-col items-center w-full justify-center px-2 mt-10">
        <div className="flex flex-col text-black md:flex-row  mb-5 items-center">
        ...
        <table className="border-collapse text-center w-10/12">
          <thead>
            <tr>
              <th className="border text-sm p-1 bg-havGreen text-black">
                Nome
              </th>
              <th className="border text-sm p-1 bg-havGreen text-black">
                Email
          ...
          <tbody>
            {(isFiltered ? sortedUsers : users).map((user) => (
              <tr
                key={user.id}
                className="border text-sm p-1 bg-white text-black"
              >
                <td className="border">{user.name}</td>
                <td className="border">{user.email}</td>
                <td className="border">{user.city}</td>
                <td className="border text-sm p-1 hidden md:table-cell">
                  {user.lat}
                </td>
                <td className="border text-sm p-1 hidden md:table-cell">
                  {user.lng}
        ...
        <div className="sm:hidden flex flex-col  justify-center w-full">
          <Button
            ...
            variant={"solid"}
            colorScheme={"gray"}
            className=" p-2 rounded w-11/12 self-center mt-10  font-light "
          >
            Filtros
          </Button>
          <Modal
